...
typedef enum 	{Leonardo_TC1, Leonardo_TC2, Leonardo_Case1, Leonardo_Case2, Leonardo_Case3, Leonardo_Case4, Leonardo_Case5, Leonardo_Case6, Leonardo_Case7,
				Leonardo_Case8_switching, Leonardo_Case9_switching,
				...
				Leonardo_Duty_12P, Leonardo_Duty_15P, Leonardo_Pattern_Q, Leonardo_Burst_18u_10kHz, Leonardo_Burst_20u_10kHz, Leonardo_TC_1_Single_Shot} OLEDStates_type;
